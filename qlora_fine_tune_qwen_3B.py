...
# Define LoRA config with the correct target modules for Qwen2.5
...
dataset = load_dataset("json", data_files="/Users/tgusain/Desktop/llama/pylang_50K_tokens.jsonl")
...
peft_model_path = "./output/qwen-ft-final"
...
# Generate text
test_prompts = ["Summarize: Your document text", "explain me pylang", "What is the purpose of pylang?", "what are some cool features that pylang offers?"]
